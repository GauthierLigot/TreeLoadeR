---
title: "Getting Started with TreeLoadeR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with TreeLoadeR}
...
- For CRAN safety, database‑dependent code must have `eval=FALSE` in vignettes.
